...
## CIS 26 Notebooks (Prof Lu) 

### Launch Notebooks (DataHub)

| Module | Notebook | Launch |
|---|---|---|
| **[Basic]** - Excel to Pandas Transition (Zillow Dataset) | `excel_to_pandas_zillow/Excel_to_Pandas_Zillow_Basic.ipynb` | [![Launch](https://img.shields.io/badge/Launch-DataHub-blue.svg)](https://elcamino.cloudbank.2i2c.cloud/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fds-modules%2Fecc-cis&branch=main&urlpath=tree%2Fecc-cis%2Fexcel_to_pandas_zillow%2FExcel_to_Pandas_Zillow_Basic.ipynb)|
| **[Advanced]** - Excel to Pandas Transition (Zillow Dataset) | `excel_to_pandas_zillow/Excel_to_Pandas_Zillow_Advanced.ipynb` | [![Launch](https://img.shields.io/badge/Launch-DataHub-blue.svg)](https://elcamino.cloudbank.2i2c.cloud/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fds-modules%2Fecc-cis&branch=main&urlpath=tree%2Fecc-cis%2Fexcel_to_pandas_zillow%2FExcel_to_Pandas_Zillow_Advanced.ipynb)|
| **Practice Exercises**: Excel to Pandas (Zillow)| `excel_to_pandas_zillow/Excel_to_Pandas_Zillow_Exercises.ipynb` | [![Launch](https://img.shields.io/badge/Launch-DataHub-blue.svg)](https://elcamino.cloudbank.2i2c.cloud/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fds-modules%2Fecc-cis&branch=main&urlpath=tree%2Fecc-cis%2Fexcel_to_pandas_zillow%2FExcel_to_Pandas_Zillow_Exercises.ipynb)|
